...
import 'package:calculadora_imc/app/modules/auth/pages/login_page.dart';
...
void main() {
  ...
  testWidgets('LoginPage test', (tester) async {
    ...
    final titleFinder = find.text('Calculadora IMC');
