...
import 'package:calculadora_imc/app/modules/auth/pages/reset_password_page.dart';
...
void main() {
  ...
  testWidgets('ResetPasswordPage test', (tester) async {
    ...
    final titleFinder = find.text('Recuperar Senha');
